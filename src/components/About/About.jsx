...
export const About = () => {
  const [lettersClasses, setLettersClasses] = useState([
    "hidden",
    "hidden",
    "hidden",
    "hidden",
        ...
        <div className="text">
          <h1>
            ...
            {typePseudo && (
              <span className="nickName">
                ...
                <span className={lettersClasses[0]} id="c">
                  {pseudoArr[0]}
                </span>
                <span className={lettersClasses[1]} id="o1">
                  {pseudoArr[1]}
                </span>
                <span className={lettersClasses[2]} id="_0">
                  {pseudoArr[2]}
                </span>
                <span className={lettersClasses[3]} id="d">
                  {pseudoArr[3]}
                </span>
                <span className={lettersClasses[4]} id="e1">
                  {pseudoArr[4]}
                </span>
                <span className={lettersClasses[5]} id="n">
                  {pseudoArr[5]}
                </span>
                <span className={lettersClasses[6]} id="a">
                  {pseudoArr[6]}
                </span>
                <span className={lettersClasses[7]} id="m">
                  {pseudoArr[7]}
                </span>
                <span className={lettersClasses[8]} id="e2">
                  {pseudoArr[8]}
                </span>
                <span className={lettersClasses[9]} id="o2">
                  {pseudoArr[9]}
                </span>
          ...
          {showBio && (
            <p className="bio">
              ...
              interactive platforms and I love what I do
            </p>
          )}
